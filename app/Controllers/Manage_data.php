...
class Manage_data extends BaseController
{
	...
	public function olah_dokumen()			//upload dan olah xlsx data normal pake phpspreadsheet, parameter-> (tanggal input , dokumen xlsx)
	{
		$rules = [
			'file_excel' => [
	...
	public function clustering($data)		//clustering normal random data
	{
		$loopke = 0;
	...
	public function process_kerangka()  	//skeleton processing normal
	{
		// 1st phase
		$rules = [
			'file_excel' => [
	...
	public function olah_dokumen_sample()		//upload dan olah xlsx 31/5 pake phpspreadsheet, parameter-> (tanggal input , dokumen xlsx)
	{
		...
		$this->clustering_sample($data);
	}

	public function clustering_sample($data)	//clustering data 31/5
	{
		$loopke = 0;
	...
	public function process_kerangka_sample()  //skeleton processing 31/5
	{
		// 1st phase
		$rules = [
			'file_excel' => [
